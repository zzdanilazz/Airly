...
interface DateFormatter {
    ...
    fun formatDate(date: Date, format: String = SECONDS_DATE_FORMAT): String

    fun formatToDate(date: String, format: String = SECONDS_DATE_FORMAT): Date?

    fun formatToDateWithCurrentTime(date: String, format: String = SECONDS_DATE_FORMAT): Date?

    companion object {
        const val PRESENTATION_DATE_FORMAT = "dd.MM.yyyy"
        const val SECONDS_DATE_FORMAT = "dd.MM.yyyy HH:mm:ss"
